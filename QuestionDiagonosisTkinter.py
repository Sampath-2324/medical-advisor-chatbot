...
def createWidget(self):
    ...
    # Adding images for Question and Diagnosis section
    question_img = Image.open("question_image.jpg")  # Replace with your image file
    question_img = question_img.resize((100, 100), Image.ANTIALIAS)
    question_photo = ImageTk.PhotoImage(question_img)
    question_label = Label(self, image=question_photo)
    question_label.image = question_photo  # Keep a reference
    question_label.grid(row=0, column=1)

    self.txtQuestion = Text(self, width=100, height=4)
    self.txtQuestion.grid(row=0, column=2, rowspan=4, columnspan=20)
    ...
    # Adding an image for the "Yes" button
    yes_img = Image.open("yes_button.jpg")  # Replace with your image file
    yes_img = yes_img.resize((80, 40), Image.ANTIALIAS)
    yes_photo = ImageTk.PhotoImage(yes_img)
    Button(self, image=yes_photo, command=self.btnYes_Click).grid(row=25, column=2)
...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Sampath A M", bg="RoyalBlue1", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="Devanshu kumar ", bg="RoyalBlue2", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam2.pack()
        self.lblTeam3=Label(self, text="shubham", bg="RoyalBlue3", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam3.pack()
